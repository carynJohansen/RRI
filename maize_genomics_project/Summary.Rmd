...
for (i in 1:length(traits)) {
  ...
  manhattan(assoc2, chr="chr", snp="rs", bp="ps", p="p_score", main=paste(t, "high freq missing removed", sep="\n"))
  qq(assoc2$p_score, main=paste(t, "Q-Q plot of GWAS p-values\nHigh Freq missing removed", sep="\n"))
}
```
